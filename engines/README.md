...
The registry lists DeepFilterNet, Qwen3-ASR, and whisper.cpp as possible future packs. They are intentionally not bundled in v0.3.5. An optional pack should be downloaded only when the buyer chooses it and should live in this folder without replacing the core app.
